    ...
    <Card.Content>
      <Feed>
        <Feed.Event>
          <Feed.Label
            style={{ marginLeft: 18 }}
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSn4TletwTYH2RC3bHmS4dw-vNbllGGgye7v67YjpS-cUur_93QaA"
          />
          <Feed.Content>
        ...
        <Feed.Event>
          <Feed.Label
            style={{ marginLeft: 18 }}
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaVR90pVuiaxHbBdugfx0XZb13MthKvblGk8XaO7qPpzdlsqlKkQ"
          />
          <Feed.Content>
        ...
        <Feed.Event>
          <Feed.Label
            style={{ marginLeft: 18 }}
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToj7_9ChVX2Ow8vKgJSppEHSTKfnWBIufEveRJQ0rS-uqaNk3g"
          />
          <Feed.Content>
